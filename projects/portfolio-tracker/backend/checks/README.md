...
> **Base de référence au 2026-09-07 : 1 704 assertions / 0 échec / 22 scripts**, mesurées par
...
> `source_registry` **75** (capacité 2, registre nominatif — #52), `actualite` **66** (capacité 3,
> axe `actualité` — #53), plus les correctifs F12→F15 sur les scripts existants. Les deux scripts
