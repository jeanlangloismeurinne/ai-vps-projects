...
> **Base de référence au 2026-09-04 : 1155 assertions / 0 échec** sur les 17 scripts hors-ligne
> (`search_worker` 52, `provenance` 50, `edgar_feed` 68, `financials_feed` 56, `synthesis_feed` 56,
...
> `knowledge_entries_listing` 100, `runner_telemetry` 49, `valuation_feed` 20, `fstring_sql` 20).
