...
> **Base de référence au 2026-09-04 : 1164 assertions / 0 échec** sur les 17 scripts hors-ligne
> (`search_worker` 52, `provenance` 50, `edgar_feed` 77, `financials_feed` 56, `synthesis_feed` 56,
