...
> **Base de référence au 2026-09-04 : 1131 assertions / 0 échec** sur les 17 scripts hors-ligne
> (`search_worker` 52, `provenance` 50, `edgar_feed` 55, `financials_feed` 45, `synthesis_feed` 56,
