...
Regroupe : les profils de champs (FIELD_PROFILES), le formatage DÉTERMINISTE des knowledge_entries
pour l'insertion en tête de prompt (discipline de cache §5.3 : tri stable, aucun champ volatil), et
le comptage par tier. MVDD_SPEC et MVDD_FIELD_PATHS supprimés au lot 3 — remplacés par les mandats
de questions des frameworks YAML.
"""
from __future__ import annotations

from typing import Any, Optional, Sequence

# ── MVDD_SPEC et MVDD_FIELD_PATHS supprimés au lot 3 ─────────────────────────
# La grille de 19 champs en dur est remplacée par les mandats de questions des frameworks YAML.
# Les planchers et profils par champ restent dans FIELD_PROFILES ci-dessous.
