...
| ID | Date | URL | Description |
|---|---|---|---|
| `1776621633353` | 19/04/2026 18:00 | `https://bank.jlmvpscode.duckdns.org/import` | Une fois sur l'écran "suivi budget" j'aimerais pouvoir cliquer sur un bouton qui |
...
| `1776621687172` | 19/04/2026 18:01 | `https://bank.jlmvpscode.duckdns.org/import` | Classe "SAS LORIN" dans Restaurant |
| `1776621334460` | 19/04/2026 17:55 | `https://bank.jlmvpscode.duckdns.org/import` | Classifie "Offre METAL" dans "Entrée mensuelle" |
| `1776621285083` | 19/04/2026 17:54 | `https://bank.jlmvpscode.duckdns.org/import` | Classifie "MON MARCHE" dans Nourriture |
| `1776611973058` | 19/04/2026 15:19 | `/budget` | Afficher le solde mensuel en gras |
| `1776611973047` | 19/04/2026 15:19 | `/budget` | Bouton export cassé sur Firefox |
